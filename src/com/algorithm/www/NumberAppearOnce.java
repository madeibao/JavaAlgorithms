...
/**
 * @program: JavaWorkSpace2->NumberAppearOnce
 * @description: 数字只是出现一次的内容
 * @author: MaYuan
...
public class NumberAppearOnce {
    ...
    public static void main(String[] args) {
        ...
        int[] num1 = new int[1];
        int[] num2 = new int[1];
        new NumberAppearOnce().findNumsAppearOnce(array, num1, num2);
        System.out.println(num1[0] + " " + num2[0]);
        num1[0] = 0;
        num2[0] = 0;
        new NumberAppearOnce().findNumsAppearOnceII(array, num1, num2);
        System.out.println(num1[0] + " " + num2[0]);
    }
}
